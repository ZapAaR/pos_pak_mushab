...
<ol class="inline-flex items-center gap-2">
    ...
    <li class="text-gray-700 font-medium">Tambah Produk</li>
</ol>
@endsection
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Lengkapi informasi produk dengan benar</p>
    </div>
...
@section('content')
<form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data" id="productForm" class="space-y-6" novalidate>
    @csrf
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Kode Produk <span class="text-gray-400 font-normal text-xs">(otomatis)</span></label>
                        <div class="relative">
                            ...
                            <input type="text" name="kode_produk" value="{{ old('kode_produk', $generatedCode) }}" readonly
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="nama_produk" value="{{ old('nama_produk') }}" placeholder="Contoh: Kopi Arabika Gayo"
                                   class="w-full pl-10 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent focus:bg-white transition-all @error('nama_produk') border-red-400 focus:ring-red-500 @enderror">
                        </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="buying_price" name="harga" value="{{ old('harga') }}" placeholder="0"
                                   class="w-full pl-10 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent focus:bg-white transition-all text-right font-semibold @error('harga') border-red-400 focus:ring-red-500 @enderror">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="stock" name="stok" value="{{ old('stok', 0) }}" min="0" placeholder="0"
                                   class="w-full pl-10 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent focus:bg-white transition-all text-right font-semibold @error('stok') border-red-400 focus:ring-red-500 @enderror">
                        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-2 lg:sticky lg:top-[22rem]">
                <button type="submit" id="submitBtn"
                        class="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-xl shadow-md shadow-green-500/30 hover:shadow-lg hover:shadow-green-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-70 disabled:cursor-not-allowed">
                    <svg class="w-5 h-5 btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
